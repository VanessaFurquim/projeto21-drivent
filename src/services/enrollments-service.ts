...
import { AddressData } from '@/protocols';

// TODO - Receber o CEP por parâmetro nesta função. DONE
async function getAddressFromCEP(cep: string): Promise<AddressData> {
  ...
  // cep é existente ?
  if (!result.data || result.data.erro === true) throw invalidDataError("This CEP does not exist!");
